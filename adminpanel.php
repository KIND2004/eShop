                    ...
                    <div class="row">
                        ...
                        <div class="offset-1 col-10 col-lg-4 mt-3 mb-3 rounded bg-light">
                            <div class="row g-1">
                                ...
                                <div class="col-12">
                                    <img src="resources/mobile images/iphone12.jpg" class="img-fluid rounded-top" />
                                    <hr />
                                </div>
                                <div class="col-12 text-center">
                        ...
                        <div class="offset-1 col-10 col-lg-4 mt-3 mb-3 rounded bg-light">
                            <div class="row g-1">
                                ...
                                <div class="col-12">
                                    <img src="resources/demoProfileImg.jpg" class="img-fluid rounded-top" style="height: 250px;margin-left: 120px;" />
                                    <hr />
                                </div>
                                <div class="col-12 text-center">
                                    <span class="fs-5 fw-bold">Abdullah Zufar</span>
                                    <br />
                                    <span class="fs-6">abdullahzufar04@gmail.com</span>
                                    <br />
                                    <span class="fs-6">0771414818</span>
                                </div>
                                <div class="col-12">
                                    <div class="firstplace"></div>
                                </div>
