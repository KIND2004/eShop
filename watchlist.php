                                            ...
                                            <div class="card mb-3 mx-0 mx-lg-3 col-12">
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        ?>
                                                        <img src="resources//products//<?php echo $arr[0]; ?>" class="img-fluid rounded-start" />
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="card-body">
                                                            ...
                                                            <br />
                                                            <span class="fw-bold text-black fs-5">Abdullah Zufar</span>
                                                            <br />
                                                            <span class="fw-bold text-black fs-5">abdullahzufar04@gmail.com</span>
                                                        </div>
                                                    </div>
