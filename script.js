    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == "1") {
                ...
                var payment = {
                    "sandbox": true,
                    "merchant_id": "1217941",    // Replace your Merchant ID
                    "return_url": "http://localhost/Abdullah_eShop/singleproductview.php?id=" + id,     // Important
                    "cancel_url": "http://localhost/Abdullah_eShop/singleproductview.php?id=" + id,     // Important
