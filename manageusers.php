...
<body style="background-color: #74EBD5;background-image: linear-gradient(90deg,#74EBD5 0%,#9FACE6 100%);min-height: 100vh;" onload="refresher('<?php echo $email; ?>');">
                    ...
                    ?>
                        ...
                        ?>
                            <div class="col-2 col-lg-2 bg-light p-1 d-none d-lg-block mt-1" onclick="viewmsgmodal();">
                                <img src="resources/user_profile/<?php echo $pcode["code"]; ?>" style="height: 40px; margin-left: 80px;">
                            </div>
                        <?php
                        ...
                        ?>
                            <div class="col-2 col-lg-2 bg-light p-1 d-none d-lg-block mt-1" onclick="viewmsgmodal();">
                                <img src="resources/demoProfileImg.jpg ?>" style="height: 40px; margin-left: 80px;">
                            </div>
                        <?php
                        }
