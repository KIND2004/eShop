                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-0 singleproduct">
                        <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                    ...
                                                    <li class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                                                        <img src="resources//products//<?php echo $d["code"]; ?>" height="130px" width="180px" class="mt-1 mb-1" id="pimg<?php echo $x; ?>" onclick="loadmainimg(<?php echo $x; ?>);" />
                                                    </li>
                                                ...
                                                ?>
                                                <li class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                                                    <img src="resources/empty.svg" height="130px" class="mt-1 mb-1" />
                                                </li>
                                                <li class="d-flex flex-column justify-content-center align-items-center border border-1 border-secondary">
                                                    <img src="resources/empty.svg" height="130px" class="mt-1 mb-1" />
                                                </li>
                                    ...
                                    <div class="col-lg-4 order-2 order-lg-1 d-none d-lg-block">
                                        <div class="d-flex flex-column align-items-center border border-1 border-secondary p-3">
                                            <div class="row">
                                                <img src="resources/products/<?php echo $img1; ?>" style="background-repeat: no-repeat; background-position: center; background-size: contain; height: 390px;" class="img-fluid" />
                                                <!-- <div style="background-image: url('resources/products/615d658205b52.jpeg'); background-repeat: no-repeat; background-size: contain; height: 450px;" id="mainimg"></div> -->
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-9 rounded border border-1 border-success mt-1">
                                                                <div class="row">
                                                            ...
                                                            <div class="col-md-6" style="margin-top: 15px;">
                                                                <div class="row">
                                                                    <div class="border border-1 border-secondary rounded overflow-hidden float-start product_qty d-inline-block position-relative">
                                                                        ...
                                                                        <input id="qtyinput" class="border-0 fs-6 fw-bold text-start mt-2 q" type="text" pattern="[0-9]*" value="1" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-4 col-lg-2">
                                                                        <i class="fas fa-heart mt-3 fs-4 text-black-50" onclick="addToWatchlist(<?php echo $pd['id']; ?>);"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="offset-1 col-10">
                                        <div class="row p-2">
                                            ...
                                            $brandrsid = Database::search("SELECT `product`.`id`,`product`.`title`,`price` FROM `product` LEFT JOIN `model_has_brand` ON `product`.`model_has_brand_id` = `model_has_brand`.`id` LIMIT 4");
                                            ...
                                            ?>
                                                ...
                                                <div class="card me-1" style="width: 18rem;">
                                                    ...
                                                    $img = Database::search("SELECT * FROM `images` WHERE `product_id` = '" . $bdf["id"] . "'");
                                                    $num = $img->num_rows;
                                                    ...
                                                    ?>
                                                    <img src="resources/products/<?php echo $arr[0]; ?>" class="card-img-top" />
                                                    <div class="card-body">
                                                        <h5 class="card-title"><?php echo $bdf["title"]; ?></h5>
                                                        <p class="card-text">Rs. <?php echo $bdf["price"]; ?> .00</p>
                                                        <input class="form-control mt-2 mb-3" type="number" value="1" id="qtytxt<?php echo $bdf['id']; ?>" />
                                                        <a href="<?php echo 'singleproductview.php?id=' . ($bdf['id']); ?>" class="btn btn-primary">Buy Now</a>
                                                        <a class="btn btn-primary" onclick="addToCart(<?php echo $bdf['id']; ?>);">Add to Cart</a>
                                                        <a href="#" class="mt-1 fs-5" onclick="addToWatchlist(<?php echo $bdf['id']; ?>);"><i class="fas fa-heart mt-1 fs-4 text-black-50"></i></a>
                                                    </div>
                                                </div>
                            ...
                            $prod = Database::search("SELECT `product`.`description`,`model_has_brand`.`brand_id`,`model_has_brand`.`model_id`  FROM `product` INNER JOIN `model_has_brand` ON `product`.`model_has_brand_id` = `model_has_brand`.`id`");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            $brand = Database::search("SELECT * FROM `brand` WHERE `id` = '" . $prod_row["brand_id"] . "'");
                                            $brow = $brand->fetch_assoc();

                                            ?>
                                            <div class="col-10">
                                                <label class="form-label fs-5 fw-bold"><?php echo $brow["name"]; ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            $model = Database::search("SELECT * FROM `model` WHERE `id` = '" . $prod_row["model_id"] . "'");
                                            $mrow = $model->fetch_assoc();

                                            ?>
                                            <div class="col-10">
                                                <label class="form-label fs-5 fw-bold"><?php echo $mrow["name"]; ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <textarea class="form-control" cols="60" rows="10" disabled><?php echo $prod_row["description"]; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <div class="col-12 col-lg-4 border border-2 border-danger rounded">
                                        <div class="row">
                                            <div class="col-12">
                                                <span class="fs-5 fw-bold text-primary">Abdullah Zufar</span>
                                            </div>
                                            <div class="col-12">
