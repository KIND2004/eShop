                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-2 col-lg-2 bg-light p-1 d-none d-lg-block mt-1" onclick="singleviewmodal('<?php echo $srow['id']; ?>');">
                            <img src="resources/products/<?php echo $icode["code"]; ?>" style="height: 60px; margin-left: 80px;">
                        </div>
                        ...
                        <div class="col-4 col-lg-1 bg-white d-grid p-1 mt-1">
                            ...
                            ?>
                                <buttonn id="blockbtn<?php echo $srow['id']; ?>" class="btn btn-success" onclick="blockproduct('<?php echo $srow['id']; ?>');">Unblock</button>
                                <?php
                            }
                                ?>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="text-center">
                                            ...
                                            ?>
                                            <img src="resources/products/<?php echo $arr[0]; ?>" style="height: 150px;" class="img-fluid">
                                        </div>
                                ...
                                <div class="row g-1 px-1">
                                    <div class="col-12 text-center bg-body border border-2 border-danger shadow rounded">
                                        <div class="row">
                                            ...
                                            <div class="col-9" onclick="addnewmodel();">
