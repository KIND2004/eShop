                    ...
                    <div class="col-12 col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rs.</span>
                                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" id="dwc" value="<?php echo $ccq1["delivery_fee_colombo"] ?>">
                                    <span class="input-group-text">.00</span>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="row mt-lg-3">
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rs.</span>
                                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" id="doc" value="<?php echo $ccq1["delivery_fee_other"] ?>">
                                    <span class="input-group-text">.00</span>
                                </div>
                            </div>
